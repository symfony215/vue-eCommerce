...
class UtilisateurData extends AbstractFixture implements FixtureInterface, OrderedFixtureInterface, ContainerAwareInterface
{
    ...
    public function load(ObjectManager $manager)
    {
       ...
       $utilisateur1->setUsername('amin');
       $utilisateur1->setEmail('amin@mail.com');
       ...
       $utilisateur2->setUsername('aymen');
       $utilisateur2->setEmail('aymen@email.com');
       ...
       $utilisateur3->setUsername('ahmed');
       $utilisateur3->setEmail('ahmed@email.com');
       ...
       $utilisateur4->setUsername('sami');
       $utilisateur4->setEmail('sami@email.com');
